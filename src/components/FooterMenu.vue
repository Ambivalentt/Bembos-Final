                ...
                <li class="flex flex-col justify-center items-center">
                    <svg data-v-e114f776="" xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                        ...
                        <path
                            ...
                            transform="translate(-897.06 -1298.058)" style="fill: rgb(251, 185, 5);"></path>
                    </svg>
                ...
                <li class="flex flex-col justify-center items-center">
                    <svg data-v-e114f776="" xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                        ...
                        <path
                            ...
                            transform="translate(-1388.056 -1297.652)" style="fill: rgb(251, 185, 5);"></path>
                    </svg>
                    <p class="text-white tracking-tighter font-semibold text-xs">MI CUENTA</p>
                </li>
            </ul>
        </section>
    </footer>
